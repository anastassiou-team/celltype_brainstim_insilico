...
net.add_nodes(cell_name='Cell_314822527',
              potental='exc',
              model_type='biophysical',
              model_template='ctdb:Biophys1.hoc',
              model_processing='aibs_perisomatic',
              dynamics_params='hof_param_314822529_0.json',
...
shutil.copyfile('./Required_files/hof_param_314822529_0.json', './SimulationH/components/biophysical_neuron_models/hof_param_314822529_0.json')
