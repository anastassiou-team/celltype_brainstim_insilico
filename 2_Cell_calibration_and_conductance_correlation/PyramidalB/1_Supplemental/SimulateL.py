...
net.add_nodes(cell_name='Cell_354190013',
              potental='exc',
              model_type='biophysical',
              model_template='ctdb:Biophys1.hoc',
              model_processing='aibs_perisomatic',
              dynamics_params='hof_param_354190013_0.json',
...
shutil.copyfile('./Required_files/hof_param_354190013_0.json', './SimulationL/components/biophysical_neuron_models/hof_param_354190013_0.json')
